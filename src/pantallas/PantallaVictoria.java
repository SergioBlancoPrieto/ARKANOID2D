...
/**
 * Esta clase crea la pantalla de victoria y administra todos sus componentes.
 * 
...
public class PantallaVictoria implements Pantalla {
     ...
     */
    public PantallaVictoria(PanelJuego juego) {
        this.juego = juego;
    }
    ...
    /**
     * Método que crea y pinta todos los componentes de la pantalla de victoria en sus respectivas posiciones
     */
    @Override
    public void PintarPantalla(Graphics g) {
        //Primero se crea un sprite con la imagen de victoria
        Sprite fondo = new Sprite(400, juego.getWidth(), 0, 0, "imagenes/victoria.png", juego);
